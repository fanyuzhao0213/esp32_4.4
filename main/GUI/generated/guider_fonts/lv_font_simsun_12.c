...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2332, .adv_w = 192, .box_w = 12, .box_h = 11, .ofs_x = 0, .ofs_y = -1},
    ...
    {.bitmap_index = 2536, .adv_w = 192, .box_w = 11, .box_h = 12, .ofs_x = 0, .ofs_y = -2},
...
static const uint16_t unicode_list_2[] = {
    0x0, 0xb, 0x25c, 0x3cf, 0x4a0, 0x1225, 0x421f, 0x4a75,
