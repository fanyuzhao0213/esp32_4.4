...
{	lv_obj_t *screen_init;
	...
	lv_obj_t *screen_systerm_imgbtn_setting;
	lv_obj_t *screen_systerm_imgbtn_setting_label;
	...
	lv_obj_t *screen_systerm_imgbtn_Pic;
	lv_obj_t *screen_systerm_imgbtn_Pic_label;
	...
	lv_obj_t *screen_setting_tabview;
	lv_obj_t *screen_setting_tabview_BoardInfo;
	lv_obj_t *screen_setting_tabview_MUSIC;
	lv_obj_t *screen_setting_tileview;
	lv_obj_t *tileview_BoardInfo;
	lv_obj_t *screen_setting_ta_angle;
	lv_obj_t *screen_setting_label_4;
	lv_obj_t *screen_setting_label_5;
	lv_obj_t *screen_setting_ta_acceleration;
	lv_obj_t *screen_setting_label_3;
	lv_obj_t *screen_setting_label_angle;
	lv_obj_t *screen_setting_ta_Voltage;
	lv_obj_t *screen_setting_ta_Rtc;
	lv_obj_t *screen_setting_ta_BoardInfo;
	lv_obj_t *screen_setting_label_2;
	lv_obj_t *screen_setting_slider_backlight;
	lv_obj_t *screen_setting_label_1;
	lv_obj_t *tileview_Test;
	lv_obj_t *screen_setting_calendar;
	lv_obj_t *screen_setting_ta_2;
	lv_obj_t *screen_setting_btn_home;
	lv_obj_t *screen_setting_btn_home_label;
	...
	lv_obj_t *screen_Picture_img_SD;
	lv_obj_t *screen_Picture_btn_Home;
	lv_obj_t *screen_Picture_btn_Home_label;
	lv_obj_t *screen_Picture_btn_Switch;
	lv_obj_t *screen_Picture_btn_Switch_label;
...
LV_IMG_DECLARE(_app_picture_320x240);
LV_IMG_DECLARE(_setting_alpha_80x50);
