...
void screen_3_timer(lv_timer_t *timer)
{
	...
	memset(temp_buf,0,20);
	sprintf(temp_buf,"%s","星期四");
	lv_label_set_text(guider_ui.screen_3_label_xingqi,temp_buf);
	memset(temp_buf,0,20);
	sprintf(temp_buf,"%s","西安");
	lv_label_set_text(guider_ui.screen_3_label_dingwei,temp_buf);
}
void setup_scr_screen_3(lv_ui *ui){
	...
	lv_obj_set_pos(ui->screen_3_label_7, 275, 170);
	...
	lv_style_set_text_font(&style_screen_3_label_7_main_main_default, &lv_font_my_hanzifont_12);
	...
	lv_obj_set_pos(ui->screen_3_img_houtian, 240, 175);
	...
	lv_style_set_text_font(&style_screen_3_label_5_main_main_default, &lv_font_my_hanzifont_12);
	...
	lv_style_set_text_font(&style_screen_3_label_6_main_main_default, &lv_font_my_hanzifont_12);
	...
	lv_style_set_text_letter_space(&style_screen_3_label_jiangshui_main_main_default, 2);
	...
	lv_style_set_text_letter_space(&style_screen_3_label_fengsu_main_main_default, 2);
	...
	lv_style_set_text_font(&style_screen_3_label_fengxiang_main_main_default, &lv_font_my_hanzifont_10);
	...
	lv_style_set_text_font(&style_screen_3_label_4_main_main_default, &lv_font_my_hanzifont_10);
	...
	lv_style_set_text_font(&style_screen_3_label_1_main_main_default, &lv_font_my_hanzifont_12);
	...
	lv_style_set_text_font(&style_screen_3_label_2_main_main_default, &lv_font_my_hanzifont_10);
	...
	lv_style_set_text_font(&style_screen_3_label_3_main_main_default, &lv_font_my_hanzifont_10);
	...
	lv_obj_set_pos(ui->screen_3_label_houtianriqi, 275, 190);
	...
	lv_style_set_text_font(&style_screen_3_label_xingqi_main_main_default, &lv_font_my_hanzifont_12);
	...
	lv_obj_set_pos(ui->screen_3_img_1, 130, 15);
	...
	lv_label_set_text(ui->screen_3_label_dingwei, "北京");
	...
	lv_style_set_text_color(&style_screen_3_label_dingwei_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_screen_3_label_dingwei_main_main_default, &lv_font_my_hanzifont_20);
	lv_style_set_text_letter_space(&style_screen_3_label_dingwei_main_main_default, 2);
    ...
    if (!screen_3_timer_enabled) {
        lv_timer_create(screen_3_timer, 1000, ui);  // 每秒更新一次时间
